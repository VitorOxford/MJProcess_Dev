...
const alertSound = ref<HTMLAudioElement | null>(null); // Ref para o novo som
...
// Observa a lista de alertas de estoque
...
const allNavItems = [
  ...
  { icon: 'mdi-image-multiple-outline', title: 'Catálogo de Estampas', value: 'seller-stamp-catalog', to: { name: 'SellerStampCatalog' }, roles: ['vendedor', 'admin'] },
